...
def batchnorm_forward(x, gamma, beta, bn_param):
    ...
    if mode == "train":
        #######################################################################
        # TODO: 实施批量规范的培训时间转发。 使用小批统计信息来计算平均值和方差，
        # 使用这些统计信息来规范化传入数据，并使用gamma和beta缩放和移动规范化数据。                      #
        #                                                                     #
        # 你应该将输出存储在变量out中。 向后传递所需的任何中间数据都应该存储在缓存变量中。                                                          #
        #                                                                     
        # 你还应该使用计算得到的样本均值和方差以及动量变量来更新运行均值和运行方差，
        # 并将结果存储在running_mean和running_var变量中。                                                          #
        #                                                                     #
        # 注意，尽管您应该跟踪运行方差，但是您应该基于标准偏差(方差的平方根)来规范化数据!                                           #
        #######################################################################
        # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        ...
        #######################################################################
        # TODO: 为批处理规范化实现测试时间转发。 
        # 使用运行的平均值和方差来规范化传入数据，然后使用gamma和beta缩放和移动规范化数据。 
        # 将结果存储在out变量中。                               
        #######################################################################
        # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
...
def batchnorm_backward(dout, cache):
    ...
    ###########################################################################
    # TODO: 实现批处理规范化的向后传递。存储的结果是dx, dgamma和dbeta变量。                        #
